                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="mant_planes.php">Planes</a></li>
                                        <li class="breadcrumb-item active">Agregar Planes</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Agregar Planes</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="form-group">
                                                <label for="projectname">ID Plan Auspiciador</label>
                                                <input type="text" id="projectname" class="form-control" placeholder="">
                                            </div>

                                            <div class="form-group">
                                                <label for="example-select">ID Sub Categoría</label>
                                                <input class="form-control" id="example-select">
                                                    
                                            </div>

                                            <div class="form-group">
                                                <label for="cant-cup">Cantidad de Cupones</label>
                                                <input type="text" id="cant-cup" class="form-control">
                                            </div>
                                ...
                                <div style="margin-left: 10px;" class="row mb-2">
                                    <div class="col-sm-4">
                                        <a href="add-products.html" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i>Guardar</a>
                                    </div>
                                    <div class="col-sm-8">
