                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Ofertas y Promociones</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Ofertas y Promociones</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="add-promo.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i>Agregar Promoción</a>
                                        </div>
                                        <div class="col-sm-8">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                                <a href="apps-ecommerce-products-details.html" class="text-body"><img src="assets/images/ofer1.png" alt="contact-img" title="contact-img" class="rounded mr-3" height="48" />
                                                                </a>
                                                                <br />
                                                        ...
                                                        <td>
                                                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br>
                                                             Voluptatum doloribus et facilis ea.
                                                        </td>
                                                        <td>
