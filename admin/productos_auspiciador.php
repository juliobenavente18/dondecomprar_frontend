                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Prudctos Auspiciador</li>
                                    </ol>
                                </div>
                                <h4 class="page-title">Productos Auspiciador</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col-sm-4">
                                            <a href="add_products_ausp.php" class="btn btn-danger mb-2"><i class="mdi mdi-plus-circle mr-2"></i>Agregar Producto</a>
                                        </div>
                                        <div class="col-sm-8">
                                            ...
                                            <table class="table table-centered w-100 dt-responsive nowrap" id="products-datatable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="assets/images/ofer1.png" alt="contact-img" title="contact-img" class="rounded mr-3" height="48" />
                                                            <p class="m-0 d-inline-block align-middle font-16">
                                                                <a href="apps-ecommerce-products-details.html" class="text-body">Zane Beer
                                                                </a>
                                                                <br />
